...
- Name: tests\navbar.spec.js >> Careers navigation works
- Location: tests\navbar.spec.js:8:1

# Error details

```
Error: locator.click: Error: strict mode violation: getByText('Careers') resolved to 3 elements:
    1) <a class="" href="/careers">Careers</a> aka getByRole('link', { name: 'Careers', exact: true })
    2) <a href="/careers" class="btn btn-accent btn-lg">…</a> aka getByRole('link', { name: '💼 Explore Careers' })
    3) <p>Join thousands of people already building careers…</p> aka getByText('Join thousands of people')

Call log:
  - waiting for getByText('Careers')
